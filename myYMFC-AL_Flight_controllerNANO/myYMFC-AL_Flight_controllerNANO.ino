...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
float pid_p_gain_roll = 0.175;               //(1.3)Gain setting for the roll P-controller
float pid_i_gain_roll = 0.0005;              //(0.04)Gain setting for the roll I-controller
float pid_d_gain_roll = 5.0;              //(18.0)Gain setting for the roll D-controller
...
float pid_p_gain_yaw = 0.2;                //(3.8)Gain setting for the pitch P-controller. //4.0
float pid_i_gain_yaw = 0.005;               //(0.015)Gain setting for the pitch I-controller. //0.02
float pid_d_gain_yaw = 0.8;                //(0.0)Gain setting for the pitch D-controller.
